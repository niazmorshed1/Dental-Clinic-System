...
<body style="padding-left: 0;">
    <div class="main-container">
        ...
        <section class="show-container">
            <div class="heading">
                <h1><img src="../image/separator.png">your service<img src="../image/separator.png"></h1>
            </div>
            <div class="box-container">
                ...
                <div class="box">
                    <form action="" method="post" class="box">
                        ...
                        <?php if($fetch_services['image'] != ''){ ?>
                            <img src="../uploaded_file/<?$sfetch_services['image']; ?>" class="image">
                      <?php  } ?>
                        <div class="status" style="color: <?php if($fetch_services['status']=='active'){echo "limegreen";} else{echo"red";} ?>;"><?$sfetch_services['status']; ?></div>
                ...
                <?php
                    ...
                    echo `
                    <div class="empty">
                     <p>No servieces added yet <br> <a href="add_service.php" class="btn" style="margin-top: 1rem;">add service</a></p>
                    </div>
                    `;
                }
                ?>
